...
function paymillEmbedFastcheckout() {
	...
	tableFragment.appendChild(paymillTableTr(
			PAYMILL_TRANSLATION_FIELDS['cardnumber'], "***********"
					+ PAYMILL_FASTCHECKOUT_DATA['last4']));
	tableFragment.appendChild(paymillTableTr(
			PAYMILL_TRANSLATION_FIELDS['expire_date'],
			PAYMILL_FASTCHECKOUT_DATA['expire_date']));
	tableFragment.appendChild(paymillTableTr(
			PAYMILL_TRANSLATION_FIELDS['cardholder'],
			PAYMILL_FASTCHECKOUT_DATA['card_holder']));
	tableFragment.appendChild(paymillTableTr(PAYMILL_TRANSLATION_FIELDS['cvc'],
			"***"));
	tableFragment.appendChild(paymillTableTr('',
			"<input type='button' class='button' id='paymill_change' value='"
					+ PAYMILL_TRANSLATION_FIELDS['changebutton'] + "'>"));
...
function paymillEmbedFrame() {
	...
	$.getScript(url, function() {
		paymill.embedFrame('paymillContainer', {
			lang : PAYMILL_TRANSLATION_FIELDS['lang']
