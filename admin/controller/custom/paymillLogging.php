...
class ControllerCustomPaymillLogging extends Controller
{
    ...
    public function index ()
    {
        ...
        if ($this->getPost("button", "search") === "delete" &&
        ...
        $data['paymillEntries'] = $this->model_custom_paymillLogging->getEntries(
                $actualPage, $searchValue);
        $data['paymillInputSearch'] = $searchValue;
        $data['paymillCheckboxConnectedSearch'] = $connectedSearch;
        
        $maxPages = (int) floor(
                $this->model_custom_paymillLogging->getTotal($searchValue) /
                         $this->model_custom_paymillLogging->getPageSize());
        ...
        $data['paymillCSS'] = $this->baseUrl .
                 '/../catalog/view/theme/default/stylesheet/paymill_styles.css';
        $data['paymillJS'] = $this->baseUrl .
                 '/../catalog/view/javascript/paymill/loggingOverview.js';
        $data['paymillAction'] = $this->url->link('custom/paymillLogging', 
        ...
        $data['paymillTableHeadDate'] = $this->language->get(
                'paymillTableHeadDate');
        $data['paymillTableHeadID'] = $this->language->get('paymillTableHeadID');
        $data['paymillTableHeadMessage'] = $this->language->get(
                'paymillTableHeadMessage');
        $data['paymillTableHeadDebug'] = $this->language->get(
                'paymillTableHeadDebug');
        $data['paymillTableHeadDetail'] = $this->language->get(
                'paymillTableHeadDetail');
        $data['paymillTableShowDetails'] = $this->language->get(
                'paymillTableShowDetails');
        $data['paymillCheckboxConnectedSearch'] = $this->language->get(
                'paymillCheckboxConnectedSearch');
        ...
        return $this->response->setOutput(
                $this->load->view('custom/paymillLogging', $data));
    }
    ...
    protected function _getBreadcrumbs ()
    {
        ...
        $breadcrumbs[] = array(
                'href' => $this->url->link('custom/paymillLogging', 
                        'token=' . $this->session->data['token'], true),
